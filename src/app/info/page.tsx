                ...
                <div className="mt-4 flex items-center gap-4">
                    ...
                    <div className="flex flex-col w-full items-start gap-[8px] ">
                        ...
                        <Typography.Paragraph color="white" size="xsm" weight="normal"
                            ...
                            their yoke. Most empires crumble from such heights. In the case of the Targaryens, their
                            slow
                            fall begins when King Viserys breaks with a century of tradition by naming his daughter
                            Rhaenyra
