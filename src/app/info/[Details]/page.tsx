    ...
    return (
        <div className="px-[16px]">
            ...
            <Typography.Title level="h1" color="white" weight="normal"
                              className="!text-[40px] font-urbanist leading-[48px] text-ellipsis">Info</Typography.Title>
            ...
            <div className="flex items-center justify-between my-[23px] pr-8">
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <Typography.Text color="gray400" weight="normal" size="xsm" className="leading-[20px] font-urbanist">Rating</Typography.Text>
                        </div>
            ...
            <Typography.Paragraph color="gray400" weight="semiBold" size="xsm"
                             className="leading-[24px] font-urbanist mt-[13px] ">Cast & Crew</Typography.Paragraph>
