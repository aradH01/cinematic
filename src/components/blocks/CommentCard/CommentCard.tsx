            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-[12px]">
                    ...
                    <div className="flex flex-col items-start">
                        <Typography.Paragraph color="white" size="md" weight="bold" className="leading-[28px] font-urbanist">{name}</Typography.Paragraph>
                        <UserStars rating={rating} className="text-[16px]" />
                    </div>
                </div>
                <Typography.Text color="white" size="sm" weight="normal" className="leading-[24px] font-urbanist">{date}</Typography.Text>
            </div>
            <Typography.Paragraph color="white700" size="md" weight="normal" className="leading-[28px] font-urbanist">{comment}</Typography.Paragraph>
        </Wrapper>
    )
}
