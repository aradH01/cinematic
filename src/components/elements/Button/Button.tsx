    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-[10px]">
                ...
                <span
                    className={addClass((outlined || ghost) ? "text-black dark:text-white font-urbanist" : "text-white dark:text-black font-urbanist", "font-medium text-[16px] font-urbanist")}
